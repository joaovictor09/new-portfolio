...
export default async function Home() {
  return (
    <div className="my-10 flex w-full flex-1 flex-col items-center justify-center overflow-x-clip px-5">
      <div className="relative flex w-full max-w-7xl flex-col items-center rounded border-b border-purple-950 bg-purple-900 bg-[url(../assets/bg-stars.svg)] p-5 shadow-2xl shadow-purple-950">
        {/* First Planet */}
        ...
        {/* About me */}
        <div className="relative z-10 flex flex-col items-center gap-5 bg-purple-900 bg-[url(../assets/bg-stars.svg)]">
      ...
      <div className="mt-5 flex w-full max-w-7xl flex-col items-center gap-2 rounded border-b border-zinc-500 bg-zinc-700/80 p-5 pt-5 text-zinc-100 shadow-md">
      ...
      <div className="mt-5 flex w-full max-w-7xl justify-center rounded border-b border-zinc-500 bg-zinc-700/80 p-5 pt-5 shadow-md">
        <Contact />
      </div>
    </div>
  )
